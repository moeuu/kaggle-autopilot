...
5. **Compatibility wrapper retirement**: after call sites move to extracted modules, remove private wrappers in
   ...
   Submit-retry artifact resume now calls `autopilot_state.py` directly. Submit autofix context formatting, stale
   repaired-artifact decisions, autofix artifact resolution,
