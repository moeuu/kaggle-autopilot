...
def test_resolved_plan_payload_keeps_full_orchestration_schema() -> None:
    payload = ResolvedPlan(
        ...
        readiness_target_score=0.91,
        readiness_method="mean_std",
        readiness_k=1.0,
        ci_method="bootstrap",
        ci_alpha=0.05,
        drift_check=True,
        ...
        rank_force_major_max_percentile=0.05,
        rank_force_major_min_teams=100,
        evaluation_contract={"metric_name": "auc", "direction": "maximize"},
    ).to_payload()
